<html>
    ...
    <body>
        ...
        if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
            // If logged in, display dropdown menu
            echo '<div class="dropdown">';
            echo '<button id="userDropdown" class="dropbtn">';
        // Use your custom SVG icon instead of the Font Awesome icon
        echo '<img src="img/user-icon.svg" alt="User Icon" style="width: 24px; height: 24px;">';
        echo '</button>';
            echo '<div class="dropdown-content" id="userDropdownContent">';
